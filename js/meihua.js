...
if (localStorage.getItem("blogbg") != undefined) {
    ...
    // 替换你自己的默认背景
    document.getElementById("defineBg").innerText = `:root{
    --default-bg: url('https://obsidian-1322827540.cos.ap-guangzhou.myqcloud.com/img/Screenshot_2024_1123_160146.png');
    --darkmode-bg:url('https://obsidian-1322827540.cos.ap-guangzhou.myqcloud.com/img/Screenshot_2024_1123_160224.png');
    --mobileday-bg: url('https://obsidian-1322827540.cos.ap-guangzhou.myqcloud.com/img/Screenshot_2024_1123_155721.png');
    --mobilenight-bg: url('https://obsidian-1322827540.cos.ap-guangzhou.myqcloud.com/img/Screenshot_2024_1123_155606.png');
  }`;
}
function changeBg(s) {
